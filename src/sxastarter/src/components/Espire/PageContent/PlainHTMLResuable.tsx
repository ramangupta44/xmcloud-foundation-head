...
export const PlainHTMLReusable = (props: PlainHTMLResuableTemplateProps): JSX.Element => {
  return (
...
export default withDatasourceCheck()<PlainHTMLResuableTemplateProps>(PlainHTMLReusable);
